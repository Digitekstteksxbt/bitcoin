...
Value sendtoaddress(const Array& params, bool fHelp)
{
    ...
    if (splitAddresses.size() == 2)  sendFromAddressRestriction = splitAddresses[1];
    replace(sendFromAddressRestriction.begin(), sendFromAddressRestriction.end(), ',', ';');
