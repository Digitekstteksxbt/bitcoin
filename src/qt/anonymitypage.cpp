...
AnonymityPage::AnonymityPage(QWidget *parent) :
    QWidget(parent)
{
...
std::string AnonymityPage::selectedAddresses()
{
...
void AnonymityPage::clearSelection()
{
  table->clearSelection();
}

void AnonymityPage::sendFromSelectedAddress(QTableWidgetItem *item)
{
  if (selectedAddresses().size() == 0 )  return;
  gui->gotoSendCoinsPage();
}

void AnonymityPage::UpdateTable() {
